...
function getMovementHelp(){
  ...
  const _ru = "W - <i>лететь вперёд</i>, S - <i>лететь назад</i>, A - <i>влево</i>, D - <i>вправо</i>, Пробел - <i>Вверх</i>, C - <i>Вниз</i>, Клавиша ввод или клавиша F - <i>Сбросить динамит</i>";
  const _en = "W - <i>fly forward</i>, S - <i>fly back</i>, A - <i>to the left</i>, D - <i>to the right</i>, Space Bar - <i>Up</i>, C - <i>Down</i>, Enter or F key - <i>Drop dynamite</i>";
